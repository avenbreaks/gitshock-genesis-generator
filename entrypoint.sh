...
WITHDRAWAL_ADDRESS="${WITHDRAWAL_ADDRESS:-0x9999995993dd7eafd2753A4c7E35c2354B112036}"
...
gen_cl_config(){
    ...
    if ! [ -f "/data/custom_config_data/genesis.ssz" ]; then
        ...
        if [[ $SHADOW_FORK_RPC != "" ]]; then
          genesis_args+=(--shadow-fork-eth1-rpc=$SHADOW_FORK_RPC --eth1-config "https://mainnet.infura.io/v3/7e33703a8620473da63e4d2ec612731f")
        else
